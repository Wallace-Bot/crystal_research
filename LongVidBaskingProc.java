...
public class LongVidBaskingProc {
	...
	*/
	...
	String testerVid ="C:/Users/Crystal Ren/Desktop/video28min/calibrate.avi";

		  //String testerVid ="C:/Users/Crystal Ren/Desktop/video28min/IMG_1477 June 28 3-04 pm very good_short period of basking_CROPPED_50000_end.avi";
	       ...
	       if( capture.isOpened())  //capture is the video file
			...
			Point center= new Point(centerX,centerY);
	    			...
	    			Imgproc.threshold(video_image, video_image, 130, 255, Imgproc.THRESH_BINARY); //thresh was 55 changed to 75
//was 145
